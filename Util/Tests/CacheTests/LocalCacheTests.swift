...
class LocalCacheTests: XCTestCase {
    ...
    func test_localCacheTests_whenCaching_thenCached() {
        let cacher = LocalCacher()
    ...
    func test_localCacheTests_whenRemoveingObject_thenRemoved() {
        let cacher = LocalCacher()
        if let image = UIImage(systemName: "book") {
    ...
    func test_localCacheTests_whenRemoveingAllObject_thenAllRemoved() {
        let cacher = LocalCacher()
